...
}:
{
  ...
  fileSystems."/mnt/home/nurnasuha" = {
    ...
    device = "nfs.localdomain:/nurnasuha";
    fsType = "nfs";
    options = [
      #"nfsvers=3"
      #"nfsvers=4.2"
...
#      '';
#
#      # Tells systemd this service depends on that mount path being available, and will fail gracefully if it’s not.
