...
#in
{
  networking.hosts = {
    ...
    "192.168.1.70"           = [ "raudah" ];                     # Thinkpad-T400
    "192.168.1.4"             = [ "sakinah"];                     # Thinkpad-X220 nurnasuha
    "192.168.1.74"           = [ "zahrah" ];                     # Thinkpad-T410 (with nvdia graphic) naim
    #"192.168.1.60"            = [ "decotamu" ];                   # deco1, tplink1
    #"192.168.1.105"           = [ "decobilik" ];                  # deco2, tplink2
    #"192.168.1.106"           = [ "dlinkkayu" ];                  # dlinkkayuap, dlink2, kayu
    "192.168.1.11"            = [ "khadijah" ];                   # Dell Precision 8400, delllaptop, najib
    "192.168.1.16"           = [ "khawlah" ];                    # Thinkpad-X230
    ...
    "192.168.1.21"            = [ "customdesktop"
                                  #"customdesktop.localdomain"     # Custom desktop. My 2'nd GigaByte motherboard. gigabytez77, desktopz77
                                ];
