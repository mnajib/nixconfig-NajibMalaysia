...
#with host;
{
  ...
  boot.kernelParams = [
    ...
    #"nouveau.modeset=1" # to enable nouveau
    #"nouveau.modeset=0" # to disable nouveau
    #"nouveau.runpm=0" # optional: If encounter issues with power management or need more stability, you can disable runtime power management for nouveau.
    #"nvidia.modeset=0" # to disable nvidia?
    #"nomodeset" "discrete" # to disable NVIDIA GPU from loading at boot
    #"video=Intel" # Use the Intel GPU for framebuffer
    #"video=i915"
    #"video=eDP-1:1920x1080"
    #"video=VGA-1:1280x1024"
    #"video=DP-1-3:1280x1024"
  ...
  # Make sure you have the necessary firmware for your NVIDIA GPU to work with nouveau.
  ...
  #   cat /var/log/Xorg.0.log | grep -i xinerama
  ...
  services.xserver = {
    ...
    #videoDrivers = [ "intel" ];  # Ensures the Intel driver is used
    #config = ''
    #  Section "Device"
    #    Identifier "Intel Graphics"
    #    Driver "intel"
    #    Option "AccelMethod" "sna"  # Or "uxa" if issues occur
    ...
    # "PCI:1:0:0"; # dedicated GPU (NVIDIA)
    # hardware.nvidia.prime.intelBusId = "PCI:0:2:0"; # integrated GPU
    ...
    #    BusID "PCI:0:2:0" # intel integrated GPU
    #    Driver         "intel"  # Use the Intel driver
    #    Option         "AccelMethod" "sna"  # Optional: SNA (Sandy Bridge New Acceleration) method for better performance
    #    Option "UseDisplayDevice" "eDP-1, VGA-1, DP-1-3"
    #  EndSection

    #  #Section "Device"
    #    #Identifier "Card0"
    #    #Driver "nouveau"
    #    #BusID "PCI:1:0:0" # nvidia dedicated GPU
    #    #Option "AccelMethod" "glamor" # Optional: Use modern acceleration
    ...
    #    Identifier     "Monitor0"
    #    Option         "Primary" "True"
    #    Option         "PreferredMode" "1920x1080" # Left monitor (eDP-1)
    #    Option         "Position" "0x0"  # First monitor in Screen0
    #  EndSection

    #  Section "Monitor"
    #    Identifier     "Monitor1"
    #    Option         "PreferredMode" "1280x1024" # Center monitor (VGA-1)
    #    Option          "RightOf" "Monitor0"
    #    Option         "Position" "0x0"  # Second monitor in Screen1
    #  EndSection

    #  Section "Monitor"
    #    Identifier     "Monitor2"
    #    Option         "PreferredMode" "1280x1024" # Right monitor (DP-1-3)
    #    Option          "RightOf" "Monitor1"
    #    Option         "Position" "1280x0"  # Monitor in Screen1
    #  EndSection
    ...
    #      #Viewport    0 0
    #      Depth       24
    #      #Virtual     3840 1080  # Virtual resolution of 2 monitors in Screen0
    #      #Virtual     3200 1080 # Combined resolution of eDP-1 (1920x1080) + VGA-1 (1280x1024)
    #      Virtual     1920 1080 # eDP-1 resolution
    #    EndSubSection
    #  EndSection
    ...
    #      #Viewport    0 0
    #      Depth       24
    #      #Virtual     1920 1080  # Virtual resolution of the single monitor
    #      Virtual     2560 1024 # Combined resolution of VGA-1 (1280x1024) + DP-1-3 (1280x1024)
    #    EndSubSection
    #  EndSection
    #'';
    #  Section "Device"
