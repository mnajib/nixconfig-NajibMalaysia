...
#
#
# nix.settings.trusted-users = [ "root" "a" ];
# sudo nixos-rebuild boot --flake .#arang --target-host a@192.168.0.116 --sudo --ask-sudo-password
#
...
in
{
  ...
  networking.hostName = "arang"; #bawang"; #"nixos"; # Define your hostname.
