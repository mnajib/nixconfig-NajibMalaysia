...
#with host;
{
  ...
  imports = [
    ...
    (./. + "/${commonDir}/users-julia-wheel.nix")
    ...
    (./. + "/${commonDir}/console-keyboard-dvorak.nix")       # keyboard layout for console environment
    (./. + "/${commonDir}/keyboard-with-msa.nix")             # keyboard layout for graphical environment
