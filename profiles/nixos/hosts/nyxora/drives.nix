...
rec {
  ...
  # MyStation drives
  zfspoolMyStation1 = { type = "by-id"; value = "ata-ST500LM021-1KJ152_W62G7G9F-part4"; };
  zfspoolMyStation2 = { type = "by-id"; value = "ata-WDC_WD5000LPVX-08V0TT6_WD-WXG1AA5A4S78-part4"; };

  driveMyStation1 = { type = "by-id"; value = "ata-ST500LM021-1KJ152_W62G7G9F"; };
  driveMyStation2 = { type = "by-id"; value = "ata-WDC_WD5000LPVX-08V0TT6_WD-WXG1AA5A4S78"; };
  #driveMyStation3 = { type = "by-id"; value = ""; };

  swapMyStation1 = { type = "by-id"; value = "ata-ST500LM021-1KJ152_W62G7G9F-part3"; };
  swapMyStation2 = { type = "by-id"; value = "ata-WDC_WD5000LPVX-08V0TT6_WD-WXG1AA5A4S78-part3"; };

  bootMyStation1 = { type = "by-id"; value = "ata-ST500LM021-1KJ152_W62G7G9F-part2"; };
  bootMyStation2 = { type = "by-id"; value = "ata-WDC_WD5000LPVX-08V0TT6_WD-WXG1AA5A4S78-part2"; };
